...
nav_order: 8
permalink: "/notes/07-write-update-delete-bulk/"
---
...
>
> - 이전: [06. Query, Search, Pagination](/notes/06-query-search-pagination/)
>
> - 다음: [08. Elasticsearch를 Database처럼 쓸 때의 제약](/notes/08-elasticsearch를-database처럼-쓸-때의-제약/)
